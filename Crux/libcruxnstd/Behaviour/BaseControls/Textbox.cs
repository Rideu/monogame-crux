...
using static libcruxnstd.CoreNStdTests;
...
namespace libcruxnstd.BaseControls
{
    public class TextBox : ControlBase // Unused
    {
        ...
        protected override void Initialize()
        {
            ...
            InputProcessor.TextInput += (sender, e) => // PERF: move to formmanager and apply input only for active control
            {
        ...
        public override void Update()
        {
            ...
            if (InputMode)
            {
                ...
                //} 
                var el = (float)GameTime.ElapsedGameTime.TotalMilliseconds;
                caretEase.Update(el);
                repeat.Update(el);
                delay.Update(el);
            }
